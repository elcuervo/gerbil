var Gerbil = function(description, tests, logger) {
  ...
  this.summary = function() {
    ...
    this.logger.warn(Gerbil.format("All tests completed for {0}: {1} passed, {2} failed of {3} tests ({4} assertions) in {5} s",
      [this.description, this.success, this.failures, this.count, assertions, elapsedTime])
    );
    this.logger.info("");
  };
