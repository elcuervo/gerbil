...
var Gerbil = function(description, tests, logger) {
  ...
  this.assert_equal = function(first, second) {
    if (!first || !second) throw new Error("attr1 = " + first + " (" + first.constructor + ")" + "and attr2 = " + second + " (" + second.constructor + ")");
    if ( typeof(first) != typeof(second) ) throw new Error("Different type " + first.constructor + " vs " + second.constructor);
