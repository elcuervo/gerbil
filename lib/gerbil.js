  ...
  this.scenario = (function() {
    ...
    this.Gerbil = (function() {
      ...
      Gerbil.prototype.assert_equal = function(obj1, obj2) {
        ...
        this.current_scenario.assertions += 1;
      ...
      Gerbil.prototype.set_timeout = function(fn, milliseconds) {
        return setTimeout((function() {
          return fn.apply(this.current_scenario);
        }), milliseconds);
      };
    ...
    return function(description, tests, logger) {
      ...
      this.set_timeout = this.current_scenario.set_timeout;
