...
var Gerbil = function(description, tests, logger) {
  ...
  this.assert_equal = function(first, second) {
    if (first == undefined || second == undefined) throw new Error("attr1 = " + first + " (" + typeof first + ") " + "and attr2 = " + second + " (" + typeof second + ")");
    if ( typeof(first) != typeof(second) ) throw new Error("Different type " + typeof first + " vs " + typeof second);
